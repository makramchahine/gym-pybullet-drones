...
RANDOM_WALK = True
NUM_TIMESTEPS_TO_CRITICAL = (55, 90) # this doesn't work
...
class TrainSimulator(BaseSimulator):
    def __init__(self, ordered_objs, ordered_rel_locs, sim_dir, start_H, target_Hs, Theta, Theta_offset, record_hz):
        ...
        num_control_steps = self.num_frames / self.record_freq_hz * self.control_freq_hz
    ...
    def step_simulation(self):
        ...
        # 79 is 3Hz
        # 26 is 9Hz
        num_steps_until_record = 79 #26 #79 #26#79
        step_counter = 0
